...
import pw.rayz.vessel.datasource.PoolConnection;
...
public class VesselConnection implements Connection {
    private PoolConnection pConnection;
    private Connection connection;

    public VesselConnection(PoolConnection connection) {
        this.pConnection = connection;
        this.connection = pConnection.getConnection();
    }
